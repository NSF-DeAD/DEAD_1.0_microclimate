...
```{r}
# Use the stored config file to define the path for the DERT Data & Metadata folder (in Dropbox) 
...
```
```{r}
# pull out rows when loggerID is 2593668
check <- L1_cleaning |>
  filter(loggerID == 2605760)
```
